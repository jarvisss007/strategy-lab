...
> **This lab is 76% of the desk's scored record (1676 of 2204 scored rows in the Calibration Observatory).** Any pooled desk statistic is therefore mostly a statement about the Arena, not about the desk. Read the other labs' standings on their own n.
...
- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+207), PANIC_LITE (+6), PULLBACK_50 (-11); cold hands: REVERSAL_3 (-91), TREND_RIDER (-543). (History, not prophecy.)
...
- PANIC_LITE contains 84% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +54 bps over 1596 trades (t=3.77) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +207 (n=440, d=116) · PANIC_LITE +6 (n=1828, d=143) · PULLBACK_50 -11 (n=197, d=40) · PANIC_BOUNCE -15 (n=906, d=123) · BOLL_SNAP -23 (n=355, d=113) · DOUBLE_DIP -26 (n=778, d=123) · DEEP_DIP -29 (n=105, d=62) · SHORT_EXT -47 (n=212, d=72) · RSI2_DIP -89 (n=512, d=43) · REVERSAL_3 -91 (n=226, d=42) · TREND_RIDER -543 (n=89, d=35)
- **calm-down**: BOLL_SNAP +359 (n=48, d=10) · PANIC_BOUNCE +186 (n=118, d=11) · PANIC_LITE +172 (n=195, d=12) · DOUBLE_DIP +144 (n=93, d=12) · PULLBACK_50 +138 (n=38, d=8) · REVERSAL_3 +132 (n=71, d=7) · FRESH_HIGH -208 (n=32, d=10) · RSI2_DIP -261 (n=105, d=8)
...
- **storm-down**: DEEP_DIP +958 (n=35, d=19) · DOUBLE_DIP +384 (n=295, d=34) · BOLL_SNAP +333 (n=293, d=32) · STORM_DIP +310 (n=474, d=35) · PANIC_BOUNCE +212 (n=314, d=33) · PANIC_LITE +152 (n=665, d=38) · FRESH_HIGH -8 (n=38, d=22)
...
- DEEP_DIP to the desk: my weather is storm-down (+958 bps, n=35); keep me on a short leash in calm-up (-29). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- DOUBLE_DIP to the desk: my weather is storm-down (+384 bps, n=295); keep me on a short leash in calm-up (-26). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+396 bps, n=19); keep me on a short leash in calm-up (-543). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+132 bps, n=71); keep me on a short leash in calm-up (-91). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+138 bps, n=38); keep me on a short leash in calm-up (-11). Status: DEAD — loses to costs/SPY.
