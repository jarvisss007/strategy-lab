# Arena Roundtable — 2026-09-19

Tape: **calm-up** · session 2026-09-18 · 12 agents · opened 44, closed 82 this session · 161 open · 2236 forward closes all-time

> **This lab is 71% of the desk's scored record (2236 of 3159 scored rows in the Calibration Observatory).** Any pooled desk statistic is therefore mostly a statement about the Arena, not about the desk. Read the other labs' standings on their own n.
...
- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+198), PANIC_LITE (-7), PULLBACK_50 (-7); cold hands: RSI2_DIP (-71), TREND_RIDER (-406). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +198 (n=441, d=114) · PANIC_LITE -7 (n=1860, d=144) · PULLBACK_50 -7 (n=186, d=37) · SHORT_EXT -16 (n=190, d=69) · DEEP_DIP -20 (n=112, d=67) · PANIC_BOUNCE -23 (n=929, d=125) · BOLL_SNAP -31 (n=360, d=118) · DOUBLE_DIP -35 (n=774, d=126) · REVERSAL_3 -41 (n=216, d=38) · RSI2_DIP -71 (n=428, d=39) · TREND_RIDER -406 (n=93, d=31)
- **calm-down**: TREND_RIDER +344 (n=24, d=10) · BOLL_SNAP +282 (n=69, d=13) · PULLBACK_50 +155 (n=42, d=10) · PANIC_BOUNCE +136 (n=135, d=14) · PANIC_LITE +101 (n=241, d=15) · REVERSAL_3 +96 (n=86, d=8) · DOUBLE_DIP +90 (n=123, d=15) · FRESH_HIGH -193 (n=32, d=11) · RSI2_DIP -195 (n=151, d=10)
...
- TREND_RIDER to the desk: my weather is calm-down (+344 bps, n=24); keep me on a short leash in calm-up (-406). Status: DEAD — loses to costs/SPY.
