...
> **This lab is 70% of the desk's scored record (2236 of 3217 scored rows in the Calibration Observatory).** Any pooled desk statistic is therefore mostly a statement about the Arena, not about the desk. Read the other labs' standings on their own n.

**Drain (ARENA-003).** 0 of 140 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 52 closed this session, 2288 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.

- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+185), DEEP_DIP (+15), PULLBACK_50 (+4); cold hands: RSI2_DIP (-66), TREND_RIDER (-197). (History, not prophecy.)
...
- PANIC_LITE contains 84% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +40 bps over 1604 trades (t=2.78) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +185 (n=441, d=112) · DEEP_DIP +15 (n=115, d=70) · PULLBACK_50 +4 (n=187, d=37) · PANIC_LITE -3 (n=1872, d=144) · PANIC_BOUNCE -22 (n=932, d=125) · BOLL_SNAP -30 (n=364, d=118) · REVERSAL_3 -34 (n=218, d=38) · DOUBLE_DIP -37 (n=772, d=127) · SHORT_EXT -40 (n=189, d=73) · RSI2_DIP -66 (n=424, d=39) · TREND_RIDER -197 (n=89, d=30)
- **calm-down**: TREND_RIDER +373 (n=24, d=10) · BOLL_SNAP +309 (n=69, d=13) · PULLBACK_50 +162 (n=42, d=10) · PANIC_BOUNCE +136 (n=135, d=14) · DOUBLE_DIP +108 (n=123, d=15) · PANIC_LITE +101 (n=241, d=15) · REVERSAL_3 +95 (n=86, d=8) · RSI2_DIP -183 (n=153, d=10) · FRESH_HIGH -195 (n=32, d=11)
...
- DEEP_DIP to the desk: my weather is calm-down (+981 bps, n=11); keep me on a short leash in calm-up (+15). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- FRESH_HIGH to the desk: my weather is storm-up (+688 bps, n=13); keep me on a short leash in calm-down (-195). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+373 bps, n=24); keep me on a short leash in calm-up (-197). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+162 bps, n=42); keep me on a short leash in calm-up (+4). Status: WATCH — positive but not significant.
