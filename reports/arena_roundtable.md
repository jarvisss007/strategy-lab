...
- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+205), PANIC_LITE (+4), PANIC_BOUNCE (-16); cold hands: RSI2_DIP (-86), TREND_RIDER (-527). (History, not prophecy.)
...
- PANIC_LITE contains 85% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +55 bps over 1592 trades (t=3.82) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +205 (n=440, d=115) · PANIC_LITE +4 (n=1860, d=145) · PANIC_BOUNCE -16 (n=917, d=125) · DOUBLE_DIP -29 (n=769, d=125) · BOLL_SNAP -30 (n=352, d=115) · PULLBACK_50 -31 (n=205, d=40) · SHORT_EXT -33 (n=200, d=66) · DEEP_DIP -43 (n=107, d=66) · REVERSAL_3 -45 (n=229, d=42) · RSI2_DIP -86 (n=501, d=43) · TREND_RIDER -527 (n=95, d=33)
...
- TREND_RIDER to the desk: my weather is calm-down (+406 bps, n=17); keep me on a short leash in calm-up (-527). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+112 bps, n=68); keep me on a short leash in calm-up (-45). Status: DEAD — loses to costs/SPY.
