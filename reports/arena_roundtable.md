...
Tape: **calm-down** · session 2026-09-10 · 12 agents · opened 70, closed 28 this session · 237 open · 1823 forward closes all-time
...
**Drain (ARENA-003).** 0 of 237 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 28 closed this session, 1823 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.

- Tape today: CALM-DOWN. Our pooled record in this weather — hot hands: BOLL_SNAP (+353), PULLBACK_50 (+254), PANIC_BOUNCE (+186); cold hands: FRESH_HIGH (-208), RSI2_DIP (-299). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +204 (n=440, d=115) · PANIC_LITE +2 (n=1860, d=145) · DEEP_DIP -18 (n=108, d=67) · PANIC_BOUNCE -18 (n=917, d=125) · DOUBLE_DIP -30 (n=769, d=125) · BOLL_SNAP -30 (n=352, d=115) · SHORT_EXT -32 (n=196, d=67) · PULLBACK_50 -37 (n=202, d=39) · REVERSAL_3 -46 (n=228, d=41) · RSI2_DIP -84 (n=494, d=42) · TREND_RIDER -561 (n=91, d=32)
- **calm-down**: BOLL_SNAP +353 (n=49, d=11) · PULLBACK_50 +254 (n=26, d=7) · PANIC_BOUNCE +186 (n=118, d=11) · PANIC_LITE +172 (n=195, d=12) · DOUBLE_DIP +144 (n=93, d=12) · REVERSAL_3 +112 (n=69, d=7) · FRESH_HIGH -208 (n=32, d=10) · RSI2_DIP -299 (n=100, d=7)
...
- TREND_RIDER to the desk: my weather is calm-down (+469 bps, n=17); keep me on a short leash in calm-up (-561). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+112 bps, n=69); keep me on a short leash in calm-up (-46). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+254 bps, n=26); keep me on a short leash in calm-up (-37). Status: DEAD — loses to costs/SPY.
