...
> **This lab is 72% of the desk's scored record (1917 of 2662 scored rows in the Calibration Observatory).** Any pooled desk statistic is therefore mostly a statement about the Arena, not about the desk. Read the other labs' standings on their own n.

**Drain (ARENA-003).** 0 of 187 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 92 closed this session, 1917 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.

- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+204), PANIC_LITE (+2), PANIC_BOUNCE (-18); cold hands: RSI2_DIP (-84), TREND_RIDER (-530). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +204 (n=441, d=115) · PANIC_LITE +2 (n=1860, d=145) · PANIC_BOUNCE -18 (n=917, d=125) · DEEP_DIP -18 (n=108, d=67) · BOLL_SNAP -27 (n=353, d=116) · DOUBLE_DIP -28 (n=769, d=125) · PULLBACK_50 -29 (n=202, d=39) · SHORT_EXT -30 (n=196, d=66) · REVERSAL_3 -40 (n=226, d=40) · RSI2_DIP -84 (n=489, d=41) · TREND_RIDER -530 (n=90, d=32)
...
- TREND_RIDER to the desk: my weather is calm-down (+397 bps, n=20); keep me on a short leash in calm-up (-530). Status: DEAD — loses to costs/SPY.
