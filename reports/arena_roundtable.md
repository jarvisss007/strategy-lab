...
Tape: **calm-up** · session 2026-09-22 · 12 agents · opened 42, closed 43 this session · 139 open · 2331 forward closes all-time
...
**Drain (ARENA-003).** 0 of 139 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 43 closed this session, 2331 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.

- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+207), DEEP_DIP (+31), PULLBACK_50 (+5); cold hands: RSI2_DIP (-60), TREND_RIDER (-152). (History, not prophecy.)
...
- PANIC_LITE contains 84% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +40 bps over 1605 trades (t=2.79) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +207 (n=440, d=112) · DEEP_DIP +31 (n=115, d=69) · PULLBACK_50 +5 (n=188, d=37) · PANIC_LITE -4 (n=1872, d=144) · REVERSAL_3 -18 (n=212, d=38) · PANIC_BOUNCE -22 (n=931, d=124) · BOLL_SNAP -32 (n=363, d=118) · SHORT_EXT -39 (n=190, d=74) · DOUBLE_DIP -40 (n=771, d=126) · RSI2_DIP -60 (n=418, d=39) · TREND_RIDER -152 (n=92, d=30)
- **calm-down**: TREND_RIDER +388 (n=24, d=10) · BOLL_SNAP +310 (n=69, d=13) · PULLBACK_50 +143 (n=42, d=10) · PANIC_BOUNCE +136 (n=135, d=14) · DOUBLE_DIP +108 (n=123, d=15) · PANIC_LITE +101 (n=241, d=15) · REVERSAL_3 +95 (n=86, d=8) · RSI2_DIP -176 (n=155, d=10) · FRESH_HIGH -203 (n=32, d=11)
...
- DEEP_DIP to the desk: my weather is calm-down (+1033 bps, n=11); keep me on a short leash in calm-up (+31). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+388 bps, n=24); keep me on a short leash in calm-up (-152). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+95 bps, n=86); keep me on a short leash in calm-up (-18). Status: WATCH — positive but not significant.
...
- PULLBACK_50 to the desk: my weather is calm-down (+143 bps, n=42); keep me on a short leash in calm-up (+5). Status: WATCH — positive but not significant.
