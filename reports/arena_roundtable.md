...
- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+204), PANIC_LITE (-1), PANIC_BOUNCE (-17); cold hands: RSI2_DIP (-53), TREND_RIDER (-435). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +204 (n=441, d=114) · PANIC_LITE -1 (n=1883, d=145) · PANIC_BOUNCE -17 (n=938, d=125) · DEEP_DIP -18 (n=113, d=68) · PULLBACK_50 -20 (n=190, d=38) · SHORT_EXT -22 (n=191, d=70) · BOLL_SNAP -28 (n=363, d=118) · DOUBLE_DIP -31 (n=776, d=127) · REVERSAL_3 -36 (n=221, d=39) · RSI2_DIP -53 (n=455, d=40) · TREND_RIDER -435 (n=95, d=32)
- **calm-down**: TREND_RIDER +392 (n=23, d=10) · BOLL_SNAP +285 (n=69, d=13) · PULLBACK_50 +133 (n=42, d=10) · PANIC_BOUNCE +131 (n=135, d=14) · PANIC_LITE +101 (n=241, d=15) · REVERSAL_3 +84 (n=86, d=8) · DOUBLE_DIP +66 (n=123, d=15) · FRESH_HIGH -195 (n=32, d=11) · RSI2_DIP -217 (n=147, d=10)
...
- TREND_RIDER to the desk: my weather is calm-down (+392 bps, n=23); keep me on a short leash in calm-up (-435). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+84 bps, n=86); keep me on a short leash in calm-up (-36). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+133 bps, n=42); keep me on a short leash in calm-up (-20). Status: WATCH — positive but not significant.
