...
**Drain (ARENA-003).** 24 of 181 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 32 closed this session, 1413 all-time. Oldest due row: DEEP_DIP GFS, entered 2026-08-17, hold 10, days_left 0. Exits are suppressed during market hours by the fill-integrity gate, so a due row right now is waiting for the next non-intraday pass, not stuck.

- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+198), PANIC_LITE (+8), PANIC_BOUNCE (-19); cold hands: REVERSAL_3 (-114), TREND_RIDER (-574). (History, not prophecy.)
...
- PANIC_LITE contains 85% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +52 bps over 1595 trades (t=3.66) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +198 (n=442) · PANIC_LITE +8 (n=1815) · PANIC_BOUNCE -19 (n=899) · PULLBACK_50 -29 (n=188) · SHORT_EXT -41 (n=217) · BOLL_SNAP -49 (n=327) · DOUBLE_DIP -54 (n=762) · DEEP_DIP -80 (n=104) · RSI2_DIP -99 (n=486) · REVERSAL_3 -114 (n=200) · TREND_RIDER -574 (n=84)
...
- DEEP_DIP to the desk: my weather is storm-down (+1034 bps, n=33); keep me on a short leash in calm-up (-80). Status: WATCH — positive but not significant.
- PANIC_BOUNCE to the desk: my weather is storm-down (+216 bps, n=307); keep me on a short leash in calm-up (-19). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
- PANIC_LITE to the desk: my weather is calm-down (+172 bps, n=195); keep me on a short leash in calm-up (+8). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
- DOUBLE_DIP to the desk: my weather is storm-down (+398 bps, n=295); keep me on a short leash in calm-up (-54). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+396 bps, n=19); keep me on a short leash in calm-up (-574). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+132 bps, n=71); keep me on a short leash in calm-up (-114). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+138 bps, n=38); keep me on a short leash in calm-up (-29). Status: DEAD — loses to costs/SPY.
