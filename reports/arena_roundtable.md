...
Tape: **calm-up** · session 2026-09-17 · 12 agents · opened 23, closed 36 this session · 198 open · 2154 forward closes all-time
...
**Drain (ARENA-003).** 0 of 198 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 36 closed this session, 2154 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.
...
- **calm-up**: FRESH_HIGH +205 (n=441, d=114) · PANIC_LITE -1 (n=1881, d=144) · PANIC_BOUNCE -17 (n=938, d=125) · SHORT_EXT -22 (n=190, d=69) · PULLBACK_50 -23 (n=189, d=38) · DEEP_DIP -27 (n=113, d=68) · BOLL_SNAP -28 (n=361, d=117) · DOUBLE_DIP -31 (n=774, d=126) · REVERSAL_3 -37 (n=215, d=38) · RSI2_DIP -53 (n=449, d=39) · TREND_RIDER -456 (n=93, d=31)
- **calm-down**: TREND_RIDER +391 (n=23, d=10) · BOLL_SNAP +272 (n=69, d=13) · PULLBACK_50 +129 (n=42, d=10) · PANIC_BOUNCE +128 (n=135, d=14) · PANIC_LITE +102 (n=241, d=15) · REVERSAL_3 +78 (n=86, d=8) · DOUBLE_DIP +50 (n=123, d=15) · FRESH_HIGH -191 (n=32, d=11) · RSI2_DIP -227 (n=147, d=10)
...
- TREND_RIDER: **19** entry days — **test LIVE (>=15)**
...
- TREND_RIDER to the desk: my weather is calm-down (+391 bps, n=23); keep me on a short leash in calm-up (-456). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+129 bps, n=42); keep me on a short leash in calm-up (-23). Status: DEAD — loses to costs/SPY.
