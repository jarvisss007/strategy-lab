...
Tape: **calm-up** · session 2026-09-22 · 12 agents · opened 42, closed 43 this session · 141 open · 2331 forward closes all-time

> **This lab is 69% of the desk's scored record (2331 of 3354 scored rows in the Calibration Observatory).** Any pooled desk statistic is therefore mostly a statement about the Arena, not about the desk. Read the other labs' standings on their own n.

**Drain (ARENA-003).** 0 of 141 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 43 closed this session, 2331 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.

- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+204), DEEP_DIP (+55), PULLBACK_50 (+18); cold hands: SHORT_EXT (-42), TREND_RIDER (-165). (History, not prophecy.)
...
- PANIC_LITE contains 84% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +38 bps over 1599 trades (t=2.7) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +204 (n=438, d=111) · DEEP_DIP +55 (n=116, d=70) · PULLBACK_50 +18 (n=179, d=36) · PANIC_LITE -5 (n=1864, d=142) · REVERSAL_3 -15 (n=207, d=36) · RSI2_DIP -18 (n=411, d=38) · PANIC_BOUNCE -23 (n=929, d=123) · BOLL_SNAP -32 (n=363, d=117) · DOUBLE_DIP -40 (n=771, d=126) · SHORT_EXT -42 (n=189, d=72) · TREND_RIDER -165 (n=91, d=30)
- **calm-down**: TREND_RIDER +386 (n=24, d=10) · BOLL_SNAP +310 (n=69, d=13) · PULLBACK_50 +157 (n=42, d=10) · PANIC_BOUNCE +136 (n=135, d=14) · DOUBLE_DIP +108 (n=123, d=15) · PANIC_LITE +101 (n=241, d=15) · REVERSAL_3 +101 (n=87, d=8) · FRESH_HIGH -203 (n=32, d=11) · RSI2_DIP -236 (n=141, d=10)
...
- DEEP_DIP to the desk: my weather is calm-down (+1018 bps, n=11); keep me on a short leash in calm-up (+55). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- FRESH_HIGH to the desk: my weather is storm-up (+688 bps, n=13); keep me on a short leash in calm-down (-203). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+386 bps, n=24); keep me on a short leash in calm-up (-165). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+101 bps, n=87); keep me on a short leash in calm-up (-15). Status: WATCH — positive but not significant.
...
- PULLBACK_50 to the desk: my weather is calm-down (+157 bps, n=42); keep me on a short leash in calm-up (+18). Status: WATCH — positive but not significant.
