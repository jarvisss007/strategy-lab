...
- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+198), PANIC_LITE (-7), PULLBACK_50 (-7); cold hands: RSI2_DIP (-71), TREND_RIDER (-404). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +198 (n=441, d=114) · PANIC_LITE -7 (n=1860, d=144) · PULLBACK_50 -7 (n=186, d=37) · SHORT_EXT -16 (n=190, d=69) · DEEP_DIP -20 (n=112, d=67) · PANIC_BOUNCE -23 (n=929, d=125) · BOLL_SNAP -31 (n=360, d=118) · DOUBLE_DIP -35 (n=774, d=126) · REVERSAL_3 -41 (n=216, d=38) · RSI2_DIP -71 (n=428, d=39) · TREND_RIDER -404 (n=93, d=31)
...
- TREND_RIDER to the desk: my weather is calm-down (+344 bps, n=24); keep me on a short leash in calm-up (-404). Status: DEAD — loses to costs/SPY.
