# Arena Roundtable — 2026-09-17

Tape: **calm-down** · session 2026-09-16 · 12 agents · opened 63, closed 96 this session · 210 open · 2119 forward closes all-time

> **This lab is 71% of the desk's scored record (2119 of 2979 scored rows in the Calibration Observatory).** Any pooled desk statistic is therefore mostly a statement about the Arena, not about the desk. Read the other labs' standings on their own n.

**Drain (ARENA-003).** 0 of 210 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 96 closed this session, 2119 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.

- Tape today: CALM-DOWN. Our pooled record in this weather — hot hands: TREND_RIDER (+364), BOLL_SNAP (+295), PANIC_BOUNCE (+123); cold hands: FRESH_HIGH (-183), RSI2_DIP (-281). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +202 (n=444, d=115) · SHORT_EXT -0 (n=197, d=69) · PANIC_LITE -2 (n=1882, d=145) · REVERSAL_3 -7 (n=223, d=39) · PANIC_BOUNCE -17 (n=938, d=125) · BOLL_SNAP -30 (n=361, d=117) · PULLBACK_50 -30 (n=195, d=38) · DOUBLE_DIP -32 (n=774, d=127) · RSI2_DIP -44 (n=456, d=40) · DEEP_DIP -46 (n=112, d=68) · TREND_RIDER -511 (n=93, d=32)
- **calm-down**: TREND_RIDER +364 (n=22, d=9) · BOLL_SNAP +295 (n=60, d=13) · PANIC_BOUNCE +123 (n=133, d=13) · PANIC_LITE +99 (n=234, d=14) · PULLBACK_50 +84 (n=35, d=9) · REVERSAL_3 +82 (n=79, d=8) · DOUBLE_DIP +28 (n=118, d=14) · FRESH_HIGH -183 (n=32, d=11) · RSI2_DIP -281 (n=131, d=9)
...
- TREND_RIDER to the desk: my weather is calm-down (+364 bps, n=22); keep me on a short leash in calm-up (-511). Status: DEAD — loses to costs/SPY.
- RSI2_DIP to the desk: my weather is storm-down (+497 bps, n=9); keep me on a short leash in calm-down (-281). Status: DEAD — loses to costs/SPY.
- REVERSAL_3 to the desk: my weather is calm-down (+82 bps, n=79); keep me on a short leash in calm-up (-7). Status: WATCH — positive but not significant.
