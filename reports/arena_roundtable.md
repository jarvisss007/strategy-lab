...
- Tape today: CALM-DOWN. Our pooled record in this weather — hot hands: BOLL_SNAP (+352), PULLBACK_50 (+254), PANIC_BOUNCE (+186); cold hands: FRESH_HIGH (-208), RSI2_DIP (-299). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +204 (n=440, d=115) · PANIC_LITE +2 (n=1860, d=145) · DEEP_DIP -18 (n=108, d=67) · PANIC_BOUNCE -18 (n=917, d=125) · DOUBLE_DIP -30 (n=769, d=125) · BOLL_SNAP -30 (n=352, d=115) · SHORT_EXT -32 (n=196, d=67) · PULLBACK_50 -37 (n=202, d=39) · REVERSAL_3 -46 (n=228, d=41) · RSI2_DIP -84 (n=494, d=42) · TREND_RIDER -562 (n=91, d=32)
- **calm-down**: BOLL_SNAP +352 (n=49, d=11) · PULLBACK_50 +254 (n=26, d=7) · PANIC_BOUNCE +186 (n=118, d=11) · PANIC_LITE +172 (n=195, d=12) · DOUBLE_DIP +144 (n=93, d=12) · REVERSAL_3 +111 (n=69, d=7) · FRESH_HIGH -208 (n=32, d=10) · RSI2_DIP -299 (n=100, d=7)
...
- REVERSAL_3 to the desk: my weather is calm-down (+111 bps, n=69); keep me on a short leash in calm-up (-46). Status: DEAD — loses to costs/SPY.
