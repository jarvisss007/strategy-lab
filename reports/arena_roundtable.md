...
> **This lab is 69% of the desk's scored record (2383 of 3441 scored rows in the Calibration Observatory).** Any pooled desk statistic is therefore mostly a statement about the Arena, not about the desk. Read the other labs' standings on their own n.

**Drain (ARENA-003).** 0 of 191 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 55 closed this session, 2392 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.

- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+212), DEEP_DIP (+31), PULLBACK_50 (+20); cold hands: SHORT_EXT (-41), TREND_RIDER (-219). (History, not prophecy.)
...
- PANIC_LITE contains 84% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +38 bps over 1629 trades (t=2.71) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +212 (n=435, d=110) · DEEP_DIP +31 (n=117, d=71) · PULLBACK_50 +20 (n=183, d=37) · PANIC_LITE -5 (n=1894, d=144) · RSI2_DIP -8 (n=424, d=40) · REVERSAL_3 -16 (n=209, d=38) · PANIC_BOUNCE -23 (n=930, d=124) · BOLL_SNAP -31 (n=375, d=118) · DOUBLE_DIP -40 (n=774, d=126) · SHORT_EXT -41 (n=192, d=76) · TREND_RIDER -219 (n=90, d=31)
- **calm-down**: TREND_RIDER +339 (n=25, d=10) · BOLL_SNAP +310 (n=69, d=13) · PULLBACK_50 +155 (n=44, d=10) · PANIC_BOUNCE +136 (n=135, d=14) · DOUBLE_DIP +108 (n=123, d=15) · PANIC_LITE +101 (n=241, d=15) · REVERSAL_3 +93 (n=85, d=8) · RSI2_DIP -227 (n=141, d=10) · FRESH_HIGH -242 (n=32, d=11)
...
- DEEP_DIP to the desk: my weather is calm-down (+929 bps, n=12); keep me on a short leash in calm-up (+31). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- SHORT_EXT to the desk: my weather is storm-down (+611 bps, n=10); keep me on a short leash in calm-up (-41). Status: DEAD — loses to costs/SPY.
- TREND_RIDER to the desk: my weather is calm-down (+339 bps, n=25); keep me on a short leash in calm-up (-219). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+155 bps, n=44); keep me on a short leash in calm-up (+20). Status: WATCH — positive but not significant.
