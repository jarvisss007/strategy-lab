...
- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+205), PANIC_LITE (-1), PANIC_BOUNCE (-17); cold hands: RSI2_DIP (-53), TREND_RIDER (-454). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +205 (n=441, d=114) · PANIC_LITE -1 (n=1881, d=144) · PANIC_BOUNCE -17 (n=938, d=125) · SHORT_EXT -22 (n=190, d=69) · PULLBACK_50 -25 (n=189, d=37) · DEEP_DIP -27 (n=113, d=68) · BOLL_SNAP -28 (n=361, d=117) · DOUBLE_DIP -31 (n=774, d=126) · REVERSAL_3 -37 (n=215, d=38) · RSI2_DIP -53 (n=449, d=39) · TREND_RIDER -454 (n=93, d=31)
- **calm-down**: TREND_RIDER +392 (n=23, d=10) · BOLL_SNAP +274 (n=69, d=13) · PULLBACK_50 +129 (n=42, d=10) · PANIC_BOUNCE +128 (n=135, d=14) · PANIC_LITE +102 (n=241, d=15) · REVERSAL_3 +79 (n=86, d=8) · DOUBLE_DIP +50 (n=123, d=15) · FRESH_HIGH -191 (n=32, d=11) · RSI2_DIP -226 (n=147, d=10)
...
- TREND_RIDER to the desk: my weather is calm-down (+392 bps, n=23); keep me on a short leash in calm-up (-454). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+79 bps, n=86); keep me on a short leash in calm-up (-37). Status: DEAD — loses to costs/SPY.
