...
> **This lab is 79% of the desk's scored record (1516 of 1913 scored rows in the Calibration Observatory).** Any pooled desk statistic is therefore mostly a statement about the Arena, not about the desk. Read the other labs' standings on their own n.
...
- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+194), PANIC_LITE (+0), PANIC_BOUNCE (-25); cold hands: RSI2_DIP (-110), TREND_RIDER (-632). (History, not prophecy.)
...
- PANIC_LITE contains 84% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +47 bps over 1610 trades (t=3.28) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +194 (n=443) · PANIC_LITE +0 (n=1836) · PANIC_BOUNCE -25 (n=910) · SHORT_EXT -36 (n=217) · PULLBACK_50 -44 (n=197) · BOLL_SNAP -50 (n=342) · DOUBLE_DIP -55 (n=777) · DEEP_DIP -103 (n=107) · REVERSAL_3 -109 (n=233) · RSI2_DIP -110 (n=519) · TREND_RIDER -632 (n=85)
...
- DEEP_DIP to the desk: my weather is storm-down (+1034 bps, n=33); keep me on a short leash in calm-up (-103). Status: WATCH — positive but not significant.
...
- DOUBLE_DIP to the desk: my weather is storm-down (+398 bps, n=295); keep me on a short leash in calm-up (-55). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+396 bps, n=19); keep me on a short leash in calm-up (-632). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+132 bps, n=71); keep me on a short leash in calm-up (-109). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+138 bps, n=38); keep me on a short leash in calm-up (-44). Status: DEAD — loses to costs/SPY.
