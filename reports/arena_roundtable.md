...
- Tape today: CALM-DOWN. Our pooled record in this weather — hot hands: TREND_RIDER (+408), BOLL_SNAP (+320), PANIC_BOUNCE (+126); cold hands: FRESH_HIGH (-177), RSI2_DIP (-316). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +201 (n=446, d=116) · PANIC_LITE -2 (n=1883, d=146) · PANIC_BOUNCE -19 (n=938, d=125) · SHORT_EXT -23 (n=196, d=69) · PULLBACK_50 -27 (n=195, d=39) · BOLL_SNAP -28 (n=361, d=117) · DOUBLE_DIP -32 (n=774, d=127) · DEEP_DIP -50 (n=112, d=68) · REVERSAL_3 -53 (n=223, d=40) · RSI2_DIP -56 (n=462, d=41) · TREND_RIDER -572 (n=96, d=32)
- **calm-down**: TREND_RIDER +408 (n=20, d=8) · BOLL_SNAP +320 (n=53, d=12) · PANIC_BOUNCE +126 (n=129, d=12) · PANIC_LITE +109 (n=217, d=13) · REVERSAL_3 +80 (n=78, d=7) · PULLBACK_50 +62 (n=34, d=8) · DOUBLE_DIP +25 (n=108, d=13) · FRESH_HIGH -177 (n=31, d=10) · RSI2_DIP -316 (n=117, d=9)
...
- TREND_RIDER to the desk: my weather is calm-down (+408 bps, n=20); keep me on a short leash in calm-up (-572). Status: DEAD — loses to costs/SPY.
- RSI2_DIP to the desk: my weather is storm-down (+497 bps, n=9); keep me on a short leash in calm-down (-316). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+62 bps, n=34); keep me on a short leash in calm-up (-27). Status: DEAD — loses to costs/SPY.
