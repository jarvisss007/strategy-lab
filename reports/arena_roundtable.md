...
Tape: **calm-down** · session 2026-09-17 · 12 agents · opened 24, closed 36 this session · 198 open · 2155 forward closes all-time
...
**Drain (ARENA-003).** 81 of 198 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 36 closed this session, 2155 all-time. Oldest due row: TREND_RIDER CRWD, entered 2026-08-27, hold 15, days_left 0. Exits are suppressed during market hours by the fill-integrity gate, so a due row right now is waiting for the next non-intraday pass, not stuck.

- Tape today: CALM-DOWN. Our pooled record in this weather — hot hands: TREND_RIDER (+392), BOLL_SNAP (+273), PULLBACK_50 (+148); cold hands: FRESH_HIGH (-193), RSI2_DIP (-222). (History, not prophecy.)
...
- PANIC_LITE contains 84% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +40 bps over 1610 trades (t=2.82) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +204 (n=441, d=114) · PANIC_LITE -1 (n=1883, d=145) · DEEP_DIP -15 (n=113, d=68) · PANIC_BOUNCE -17 (n=938, d=125) · SHORT_EXT -18 (n=191, d=70) · PULLBACK_50 -19 (n=190, d=38) · BOLL_SNAP -29 (n=363, d=118) · DOUBLE_DIP -31 (n=776, d=127) · REVERSAL_3 -38 (n=221, d=39) · RSI2_DIP -53 (n=455, d=40) · TREND_RIDER -466 (n=95, d=32)
- **calm-down**: TREND_RIDER +392 (n=23, d=10) · BOLL_SNAP +273 (n=69, d=13) · PULLBACK_50 +148 (n=42, d=10) · PANIC_BOUNCE +134 (n=135, d=14) · PANIC_LITE +100 (n=241, d=15) · REVERSAL_3 +87 (n=86, d=8) · DOUBLE_DIP +79 (n=123, d=15) · FRESH_HIGH -193 (n=32, d=11) · RSI2_DIP -222 (n=147, d=10)
...
- DEEP_DIP to the desk: my weather is storm-down (+867 bps, n=27); keep me on a short leash in calm-up (-15). Status: WATCH — positive but not significant.
...
- TREND_RIDER to the desk: my weather is calm-down (+392 bps, n=23); keep me on a short leash in calm-up (-466). Status: DEAD — loses to costs/SPY.
- RSI2_DIP to the desk: my weather is storm-down (+497 bps, n=9); keep me on a short leash in calm-down (-222). Status: DEAD — loses to costs/SPY.
- REVERSAL_3 to the desk: my weather is calm-down (+87 bps, n=86); keep me on a short leash in calm-up (-38). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+148 bps, n=42); keep me on a short leash in calm-up (-19). Status: WATCH — positive but not significant.
