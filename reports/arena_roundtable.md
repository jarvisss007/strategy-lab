...
**Drain (ARENA-003).** 0 of 123 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 49 closed this session, 1725 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.
...
- **calm-up**: FRESH_HIGH +204 (n=438, d=115) · PANIC_LITE +6 (n=1819, d=142) · PULLBACK_50 -6 (n=185, d=40) · PANIC_BOUNCE -16 (n=905, d=122) · BOLL_SNAP -23 (n=340, d=112) · DOUBLE_DIP -26 (n=760, d=122) · DEEP_DIP -28 (n=106, d=63) · SHORT_EXT -35 (n=208, d=73) · RSI2_DIP -70 (n=503, d=42) · REVERSAL_3 -82 (n=225, d=41) · TREND_RIDER -546 (n=86, d=34)
