...
- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+208), DEEP_DIP (+24), PULLBACK_50 (+9); cold hands: RSI2_DIP (-58), TREND_RIDER (-201). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +208 (n=440, d=112) · DEEP_DIP +24 (n=115, d=69) · PULLBACK_50 +9 (n=188, d=37) · PANIC_LITE -4 (n=1872, d=144) · REVERSAL_3 -19 (n=212, d=38) · PANIC_BOUNCE -23 (n=931, d=124) · BOLL_SNAP -32 (n=363, d=118) · SHORT_EXT -38 (n=190, d=74) · DOUBLE_DIP -39 (n=771, d=126) · RSI2_DIP -58 (n=418, d=39) · TREND_RIDER -201 (n=92, d=30)
- **calm-down**: TREND_RIDER +372 (n=24, d=10) · BOLL_SNAP +310 (n=69, d=13) · PULLBACK_50 +150 (n=42, d=10) · PANIC_BOUNCE +136 (n=135, d=14) · DOUBLE_DIP +108 (n=123, d=15) · PANIC_LITE +101 (n=241, d=15) · REVERSAL_3 +95 (n=86, d=8) · RSI2_DIP -176 (n=155, d=10) · FRESH_HIGH -200 (n=32, d=11)
...
- DEEP_DIP to the desk: my weather is calm-down (+998 bps, n=11); keep me on a short leash in calm-up (+24). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+372 bps, n=24); keep me on a short leash in calm-up (-201). Status: DEAD — loses to costs/SPY.
