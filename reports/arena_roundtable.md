...
- PANIC_LITE contains 85% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +53 bps over 1595 trades (t=3.72) — the bounce is not only in the extreme tail.
...
- PANIC_LITE: **24** entry days — **test LIVE (>=15)**
- PANIC_BOUNCE: **23** entry days — **test LIVE (>=15)**
- RSI2_DIP: **23** entry days — **test LIVE (>=15)**
- REVERSAL_3: **22** entry days — **test LIVE (>=15)**
- PULLBACK_50: **22** entry days — **test LIVE (>=15)**
- DOUBLE_DIP: **21** entry days — **test LIVE (>=15)**
- BOLL_SNAP: **17** entry days — **test LIVE (>=15)**
- FRESH_HIGH: **11** entry days
- DEEP_DIP: **11** entry days
...
- DEEP_DIP to the desk: my weather is storm-down (+1034 bps, n=33); keep me on a short leash in calm-up (-74). Status: WATCH — positive but not significant.
- PANIC_BOUNCE to the desk: my weather is storm-down (+216 bps, n=307); keep me on a short leash in calm-up (-18). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
- PANIC_LITE to the desk: my weather is calm-down (+172 bps, n=195); keep me on a short leash in calm-up (+10). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+396 bps, n=19); keep me on a short leash in calm-up (-560). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+132 bps, n=71); keep me on a short leash in calm-up (-115). Status: DEAD — loses to costs/SPY.
