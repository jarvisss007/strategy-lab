...
Tape: **calm-up** · session 2026-09-01 · 12 agents · opened 102, closed 79 this session · 231 open · 1516 forward closes all-time

> **This lab is 80% of the desk's scored record (1437 of 1797 scored rows in the Calibration Observatory).** Any pooled desk statistic is therefore mostly a statement about the Arena, not about the desk. Read the other labs' standings on their own n.

**Drain (ARENA-003).** 0 of 231 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 79 closed this session, 1516 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.

- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+194), PANIC_LITE (+1), PANIC_BOUNCE (-25); cold hands: REVERSAL_3 (-113), TREND_RIDER (-624). (History, not prophecy.)
...
- PANIC_LITE contains 85% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +47 bps over 1601 trades (t=3.28) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +194 (n=443) · PANIC_LITE +1 (n=1824) · PANIC_BOUNCE -25 (n=902) · SHORT_EXT -38 (n=217) · PULLBACK_50 -42 (n=190) · BOLL_SNAP -56 (n=333) · DOUBLE_DIP -58 (n=769) · DEEP_DIP -106 (n=106) · RSI2_DIP -110 (n=509) · REVERSAL_3 -113 (n=217) · TREND_RIDER -624 (n=84)
...
- DEEP_DIP to the desk: my weather is storm-down (+1034 bps, n=33); keep me on a short leash in calm-up (-106). Status: WATCH — positive but not significant.
...
- PANIC_LITE to the desk: my weather is calm-down (+172 bps, n=195); keep me on a short leash in calm-up (+1). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
- DOUBLE_DIP to the desk: my weather is storm-down (+398 bps, n=295); keep me on a short leash in calm-up (-58). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+396 bps, n=19); keep me on a short leash in calm-up (-624). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+132 bps, n=71); keep me on a short leash in calm-up (-113). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+138 bps, n=38); keep me on a short leash in calm-up (-42). Status: DEAD — loses to costs/SPY.
