...
- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+184), DEEP_DIP (+15), PULLBACK_50 (+4); cold hands: RSI2_DIP (-67), TREND_RIDER (-197). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +184 (n=443, d=113) · DEEP_DIP +15 (n=115, d=70) · PULLBACK_50 +4 (n=187, d=37) · PANIC_LITE -3 (n=1872, d=144) · PANIC_BOUNCE -22 (n=932, d=125) · BOLL_SNAP -30 (n=364, d=118) · REVERSAL_3 -34 (n=218, d=38) · DOUBLE_DIP -37 (n=772, d=127) · SHORT_EXT -40 (n=189, d=73) · RSI2_DIP -67 (n=424, d=39) · TREND_RIDER -197 (n=89, d=30)
- **calm-down**: TREND_RIDER +373 (n=24, d=10) · BOLL_SNAP +310 (n=69, d=13) · PULLBACK_50 +163 (n=42, d=10) · PANIC_BOUNCE +136 (n=135, d=14) · DOUBLE_DIP +108 (n=123, d=15) · PANIC_LITE +101 (n=241, d=15) · REVERSAL_3 +95 (n=86, d=8) · RSI2_DIP -183 (n=153, d=10) · FRESH_HIGH -195 (n=32, d=11)
...
- PULLBACK_50 to the desk: my weather is calm-down (+163 bps, n=42); keep me on a short leash in calm-up (+4). Status: WATCH — positive but not significant.
