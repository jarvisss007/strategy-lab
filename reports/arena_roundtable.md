...
**Drain (ARENA-003).** 0 of 121 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 161 closed this session, 1347 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.

- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+177), PANIC_LITE (+2), PULLBACK_50 (-23); cold hands: DEEP_DIP (-136), TREND_RIDER (-501). (History, not prophecy.)
...
- PANIC_LITE contains 85% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +50 bps over 1578 trades (t=3.46) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +177 (n=457) · PANIC_LITE +2 (n=1792) · PULLBACK_50 -23 (n=193) · PANIC_BOUNCE -25 (n=893) · SHORT_EXT -50 (n=217) · DOUBLE_DIP -52 (n=768) · BOLL_SNAP -57 (n=336) · RSI2_DIP -98 (n=477) · REVERSAL_3 -132 (n=192) · DEEP_DIP -136 (n=104) · TREND_RIDER -501 (n=82)
...
- DEEP_DIP to the desk: my weather is storm-down (+1034 bps, n=33); keep me on a short leash in calm-up (-136). Status: WATCH — positive but not significant.
- PANIC_BOUNCE to the desk: my weather is storm-down (+216 bps, n=308); keep me on a short leash in calm-up (-25). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+396 bps, n=19); keep me on a short leash in calm-up (-501). Status: DEAD — loses to costs/SPY.
...
- PULLBACK_50 to the desk: my weather is calm-down (+150 bps, n=39); keep me on a short leash in calm-up (-23). Status: DEAD — loses to costs/SPY.
