...
> **This lab is 74% of the desk's scored record (1765 of 2397 scored rows in the Calibration Observatory).** Any pooled desk statistic is therefore mostly a statement about the Arena, not about the desk. Read the other labs' standings on their own n.
...
- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+208), PANIC_LITE (+5), PANIC_BOUNCE (-17); cold hands: RSI2_DIP (-85), TREND_RIDER (-504). (History, not prophecy.)
...
- PANIC_LITE contains 84% of PANIC_BOUNCE's entries; stripped to the −3%…−5% band alone (PANIC_LITE entries too shallow for PANIC_BOUNCE), it still earned +54 bps over 1580 trades (t=3.71) — the bounce is not only in the extreme tail.
...
- **calm-up**: FRESH_HIGH +208 (n=439, d=115) · PANIC_LITE +5 (n=1837, d=144) · PANIC_BOUNCE -17 (n=911, d=124) · SHORT_EXT -22 (n=203, d=70) · PULLBACK_50 -28 (n=190, d=39) · BOLL_SNAP -28 (n=348, d=114) · DOUBLE_DIP -28 (n=766, d=124) · DEEP_DIP -35 (n=106, d=64) · REVERSAL_3 -53 (n=212, d=41) · RSI2_DIP -85 (n=485, d=42) · TREND_RIDER -504 (n=94, d=34)
...
- DEEP_DIP to the desk: my weather is storm-down (+1224 bps, n=32); keep me on a short leash in calm-up (-35). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
- PANIC_BOUNCE to the desk: my weather is storm-down (+249 bps, n=300); keep me on a short leash in calm-up (-17). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- DOUBLE_DIP to the desk: my weather is storm-down (+432 bps, n=286); keep me on a short leash in calm-up (-28). Status: UNPROVEN — FAILED the deflation gate 2026-08-08 (DSR 0.233, PBO 0.474).
...
- TREND_RIDER to the desk: my weather is calm-down (+321 bps, n=20); keep me on a short leash in calm-up (-504). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+166 bps, n=79); keep me on a short leash in calm-up (-53). Status: DEAD — loses to costs/SPY.
