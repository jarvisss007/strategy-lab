...
Tape: **calm-up** · session 2026-09-14 · 12 agents · opened 104, closed 62 this session · 227 open · 1980 forward closes all-time
...
**Drain (ARENA-003).** 0 of 227 open rows read `days_left <= 0`; 0 of those are PAST due (negative). 62 closed this session, 1980 all-time. No due rows on the book. This pass ran outside market hours, so every due row was eligible to close.

- Tape today: CALM-UP. Our pooled record in this weather — hot hands: FRESH_HIGH (+195), PANIC_LITE (+2), PULLBACK_50 (-17); cold hands: RSI2_DIP (-79), TREND_RIDER (-584). (History, not prophecy.)
...
- **calm-up**: FRESH_HIGH +195 (n=449, d=116) · PANIC_LITE +2 (n=1861, d=146) · PULLBACK_50 -17 (n=199, d=39) · PANIC_BOUNCE -18 (n=917, d=125) · BOLL_SNAP -26 (n=355, d=117) · SHORT_EXT -26 (n=194, d=68) · DOUBLE_DIP -31 (n=773, d=126) · DEEP_DIP -35 (n=109, d=68) · REVERSAL_3 -44 (n=227, d=40) · RSI2_DIP -79 (n=482, d=41) · TREND_RIDER -584 (n=92, d=31)
- **calm-down**: TREND_RIDER +408 (n=20, d=8) · BOLL_SNAP +340 (n=52, d=11) · PANIC_BOUNCE +126 (n=129, d=12) · PANIC_LITE +109 (n=217, d=13) · REVERSAL_3 +80 (n=78, d=7) · PULLBACK_50 +78 (n=34, d=8) · DOUBLE_DIP +58 (n=108, d=13) · FRESH_HIGH -223 (n=31, d=10) · RSI2_DIP -293 (n=117, d=8)
...
- TREND_RIDER to the desk: my weather is calm-down (+408 bps, n=20); keep me on a short leash in calm-up (-584). Status: DEAD — loses to costs/SPY.
...
- REVERSAL_3 to the desk: my weather is calm-down (+80 bps, n=78); keep me on a short leash in calm-up (-44). Status: DEAD — loses to costs/SPY.
